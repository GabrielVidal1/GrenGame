...
public class PlantEditor : Editor {
	...
	public override void OnInspectorGUI ()
	{
		...
		if (myObject.initialShapeOverLength == null)
			myObject.initialShapeOverLength = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.finalShapeOverLength == null)
			myObject.finalShapeOverLength = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.shapeOverTime == null)
			myObject.shapeOverTime = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.lengthOverTime == null)
			myObject.lengthOverTime = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.segmentLengthOverLength == null)
			myObject.segmentLengthOverLength = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.hasGravity) {
			...
			if (myObject.gravityOverLength == null)
				myObject.gravityOverLength = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.hasNoise) {
			...
			if (myObject.noiseOverLength == null)
				myObject.noiseOverLength = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.hasLeaves) {
			...
			if (myObject.leafPrefab != null) {
				...
				if (myObject.leavesDistribution == null)
					myObject.leavesDistribution = AnimationCurve.Linear (0, 0, 1, 1);
		...
		if (myObject.hasRecursions) {
			...
			if (myObject.branchesDistribution == null)
				myObject.branchesDistribution = AnimationCurve.Linear (0, 0, 1, 1);
			...
			if (myObject.branchBirthDateDistribution == null)
				myObject.branchBirthDateDistribution = AnimationCurve.Linear (0, 0, 1, 1);
			...
			if (myObject.branchesTangencityOverLength == null)
				myObject.branchesTangencityOverLength = AnimationCurve.Linear (0, 0, 1, 1);
			...
			if (myObject.branchLengthOverTrunkLength == null)
				myObject.branchLengthOverTrunkLength = AnimationCurve.Linear (0, 0, 1, 1);
